...
import (
	v1 "github.com/dims/openshell-driver-substrate/cmd/kubectl-osh/pkg/proto/datamodel/v1"
	v11 "github.com/dims/openshell-driver-substrate/cmd/kubectl-osh/pkg/proto/sandbox/v1"
...
type IssueSandboxTokenResponse struct {
	...
	// Absolute expiry of the issued token, milliseconds since the epoch.
...
type RefreshSandboxTokenResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	// Absolute expiry of the new token, milliseconds since the epoch.
	ExpiresAtMs   int64 `protobuf:"varint,2,opt,name=expires_at_ms,json=expiresAtMs,proto3" json:"expires_at_ms,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_openshell_proto_rawDesc = "" +
	...
	"\bseverity\x18\x05 \x01(\tR\bseverity\"\xac\x02\n" +
	...
	"queryParam\x12A\n" +
	"\arefresh\x18\b \x01(\v2'.openshell.v1.ProviderCredentialRefreshR\arefresh\"\x8d\x01\n" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted\"\xed\x03\n" +
	...
	"\tdiscovery\x18\t \x01(\v2&.openshell.v1.ProviderProfileDiscoveryR\tdiscovery\"\x90\x01\n" +
	...
	"\x1aCredentialExpiresAtMsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x9a\x03\n" +
	...
	"\x18SERVICE_STATUS_UNHEALTHY\x10\x032\x84*\n" +
	"\tOpenShell\x12C\n" +
	...
	"\x13RefreshSandboxToken\x12(.openshell.v1.RefreshSandboxTokenRequest\x1a).openshell.v1.RefreshSandboxTokenResponseB_Z]github.com/dims/openshell-driver-substrate/cmd/kubectl-osh/pkg/proto/openshell/v1;openshellv1b\x06proto3"
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 163)
var file_openshell_proto_goTypes = []any{
	...
	(*SandboxTemplate)(nil),                       // 13: openshell.v1.SandboxTemplate
	(*SandboxStatus)(nil),                         // 14: openshell.v1.SandboxStatus
	(*SandboxCondition)(nil),                      // 15: openshell.v1.SandboxCondition
	(*PlatformEvent)(nil),                         // 16: openshell.v1.PlatformEvent
	(*CreateSandboxRequest)(nil),                  // 17: openshell.v1.CreateSandboxRequest
	(*GetSandboxRequest)(nil),                     // 18: openshell.v1.GetSandboxRequest
	(*ListSandboxesRequest)(nil),                  // 19: openshell.v1.ListSandboxesRequest
	(*ListSandboxProvidersRequest)(nil),           // 20: openshell.v1.ListSandboxProvidersRequest
	(*AttachSandboxProviderRequest)(nil),          // 21: openshell.v1.AttachSandboxProviderRequest
	(*DetachSandboxProviderRequest)(nil),          // 22: openshell.v1.DetachSandboxProviderRequest
	(*DeleteSandboxRequest)(nil),                  // 23: openshell.v1.DeleteSandboxRequest
	(*SandboxResponse)(nil),                       // 24: openshell.v1.SandboxResponse
	(*ListSandboxesResponse)(nil),                 // 25: openshell.v1.ListSandboxesResponse
	(*ListSandboxProvidersResponse)(nil),          // 26: openshell.v1.ListSandboxProvidersResponse
	(*AttachSandboxProviderResponse)(nil),         // 27: openshell.v1.AttachSandboxProviderResponse
	(*DetachSandboxProviderResponse)(nil),         // 28: openshell.v1.DetachSandboxProviderResponse
	(*DeleteSandboxResponse)(nil),                 // 29: openshell.v1.DeleteSandboxResponse
	(*CreateSshSessionRequest)(nil),               // 30: openshell.v1.CreateSshSessionRequest
	(*CreateSshSessionResponse)(nil),              // 31: openshell.v1.CreateSshSessionResponse
	(*ExposeServiceRequest)(nil),                  // 32: openshell.v1.ExposeServiceRequest
	(*GetServiceRequest)(nil),                     // 33: openshell.v1.GetServiceRequest
	(*ListServicesRequest)(nil),                   // 34: openshell.v1.ListServicesRequest
	(*ListServicesResponse)(nil),                  // 35: openshell.v1.ListServicesResponse
	(*DeleteServiceRequest)(nil),                  // 36: openshell.v1.DeleteServiceRequest
	(*DeleteServiceResponse)(nil),                 // 37: openshell.v1.DeleteServiceResponse
	(*ServiceEndpoint)(nil),                       // 38: openshell.v1.ServiceEndpoint
	(*ServiceEndpointResponse)(nil),               // 39: openshell.v1.ServiceEndpointResponse
	(*RevokeSshSessionRequest)(nil),               // 40: openshell.v1.RevokeSshSessionRequest
	(*RevokeSshSessionResponse)(nil),              // 41: openshell.v1.RevokeSshSessionResponse
	(*ExecSandboxRequest)(nil),                    // 42: openshell.v1.ExecSandboxRequest
	(*ExecSandboxStdout)(nil),                     // 43: openshell.v1.ExecSandboxStdout
	(*ExecSandboxStderr)(nil),                     // 44: openshell.v1.ExecSandboxStderr
	(*ExecSandboxExit)(nil),                       // 45: openshell.v1.ExecSandboxExit
	(*ExecSandboxEvent)(nil),                      // 46: openshell.v1.ExecSandboxEvent
	(*TcpForwardInit)(nil),                        // 47: openshell.v1.TcpForwardInit
	(*TcpForwardFrame)(nil),                       // 48: openshell.v1.TcpForwardFrame
	(*ExecSandboxInput)(nil),                      // 49: openshell.v1.ExecSandboxInput
	(*ExecSandboxWindowResize)(nil),               // 50: openshell.v1.ExecSandboxWindowResize
	(*SshSession)(nil),                            // 51: openshell.v1.SshSession
	(*WatchSandboxRequest)(nil),                   // 52: openshell.v1.WatchSandboxRequest
	(*SandboxStreamEvent)(nil),                    // 53: openshell.v1.SandboxStreamEvent
	(*SandboxLogLine)(nil),                        // 54: openshell.v1.SandboxLogLine
	(*SandboxStreamWarning)(nil),                  // 55: openshell.v1.SandboxStreamWarning
	(*CreateProviderRequest)(nil),                 // 56: openshell.v1.CreateProviderRequest
	(*GetProviderRequest)(nil),                    // 57: openshell.v1.GetProviderRequest
	(*ListProvidersRequest)(nil),                  // 58: openshell.v1.ListProvidersRequest
	(*UpdateProviderRequest)(nil),                 // 59: openshell.v1.UpdateProviderRequest
	(*DeleteProviderRequest)(nil),                 // 60: openshell.v1.DeleteProviderRequest
	(*ProviderResponse)(nil),                      // 61: openshell.v1.ProviderResponse
	(*ListProvidersResponse)(nil),                 // 62: openshell.v1.ListProvidersResponse
	(*ListProviderProfilesRequest)(nil),           // 63: openshell.v1.ListProviderProfilesRequest
	(*GetProviderProfileRequest)(nil),             // 64: openshell.v1.GetProviderProfileRequest
	(*ProviderProfileImportItem)(nil),             // 65: openshell.v1.ProviderProfileImportItem
	(*ProviderProfileDiagnostic)(nil),             // 66: openshell.v1.ProviderProfileDiagnostic
	(*ProviderProfileCredential)(nil),             // 67: openshell.v1.ProviderProfileCredential
	(*ProviderCredentialRefreshMaterial)(nil),     // 68: openshell.v1.ProviderCredentialRefreshMaterial
	(*ProviderCredentialRefresh)(nil),             // 69: openshell.v1.ProviderCredentialRefresh
	(*ProviderCredentialRefreshStatus)(nil),       // 70: openshell.v1.ProviderCredentialRefreshStatus
	(*ProviderProfileDiscovery)(nil),              // 71: openshell.v1.ProviderProfileDiscovery
	(*StoredProviderCredentialRefreshState)(nil),  // 72: openshell.v1.StoredProviderCredentialRefreshState
	(*GetProviderRefreshStatusRequest)(nil),       // 73: openshell.v1.GetProviderRefreshStatusRequest
	(*GetProviderRefreshStatusResponse)(nil),      // 74: openshell.v1.GetProviderRefreshStatusResponse
	(*ConfigureProviderRefreshRequest)(nil),       // 75: openshell.v1.ConfigureProviderRefreshRequest
	(*ConfigureProviderRefreshResponse)(nil),      // 76: openshell.v1.ConfigureProviderRefreshResponse
	(*RotateProviderCredentialRequest)(nil),       // 77: openshell.v1.RotateProviderCredentialRequest
	(*RotateProviderCredentialResponse)(nil),      // 78: openshell.v1.RotateProviderCredentialResponse
	(*DeleteProviderRefreshRequest)(nil),          // 79: openshell.v1.DeleteProviderRefreshRequest
	(*DeleteProviderRefreshResponse)(nil),         // 80: openshell.v1.DeleteProviderRefreshResponse
	(*ProviderProfile)(nil),                       // 81: openshell.v1.ProviderProfile
	(*StoredProviderProfile)(nil),                 // 82: openshell.v1.StoredProviderProfile
	(*ProviderProfileResponse)(nil),               // 83: openshell.v1.ProviderProfileResponse
	(*ListProviderProfilesResponse)(nil),          // 84: openshell.v1.ListProviderProfilesResponse
	(*ImportProviderProfilesRequest)(nil),         // 85: openshell.v1.ImportProviderProfilesRequest
	(*ImportProviderProfilesResponse)(nil),        // 86: openshell.v1.ImportProviderProfilesResponse
	(*LintProviderProfilesRequest)(nil),           // 87: openshell.v1.LintProviderProfilesRequest
	(*LintProviderProfilesResponse)(nil),          // 88: openshell.v1.LintProviderProfilesResponse
	(*DeleteProviderResponse)(nil),                // 89: openshell.v1.DeleteProviderResponse
	(*DeleteProviderProfileRequest)(nil),          // 90: openshell.v1.DeleteProviderProfileRequest
	(*DeleteProviderProfileResponse)(nil),         // 91: openshell.v1.DeleteProviderProfileResponse
	(*GetSandboxProviderEnvironmentRequest)(nil),  // 92: openshell.v1.GetSandboxProviderEnvironmentRequest
	(*GetSandboxProviderEnvironmentResponse)(nil), // 93: openshell.v1.GetSandboxProviderEnvironmentResponse
	(*UpdateConfigRequest)(nil),                   // 94: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                  // 95: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                        // 96: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                 // 97: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                     // 98: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                          // 99: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                         // 100: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                   // 101: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                  // 102: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),         // 103: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),        // 104: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),            // 105: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),           // 106: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),             // 107: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),            // 108: openshell.v1.ReportPolicyStatusResponse
	(*SandboxPolicyRevision)(nil),                 // 109: openshell.v1.SandboxPolicyRevision
	(*GetSandboxLogsRequest)(nil),                 // 110: openshell.v1.GetSandboxLogsRequest
	(*PushSandboxLogsRequest)(nil),                // 111: openshell.v1.PushSandboxLogsRequest
	(*PushSandboxLogsResponse)(nil),               // 112: openshell.v1.PushSandboxLogsResponse
	(*GetSandboxLogsResponse)(nil),                // 113: openshell.v1.GetSandboxLogsResponse
	(*SupervisorMessage)(nil),                     // 114: openshell.v1.SupervisorMessage
	(*GatewayMessage)(nil),                        // 115: openshell.v1.GatewayMessage
	(*SupervisorHello)(nil),                       // 116: openshell.v1.SupervisorHello
	(*SessionAccepted)(nil),                       // 117: openshell.v1.SessionAccepted
	(*SessionRejected)(nil),                       // 118: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                   // 119: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                      // 120: openshell.v1.GatewayHeartbeat
	(*RelayOpen)(nil),                             // 121: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                        // 122: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                        // 123: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                             // 124: openshell.v1.RelayInit
	(*RelayFrame)(nil),                            // 125: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                       // 126: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                            // 127: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                       // 128: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                         // 129: openshell.v1.DenialSummary
	(*PolicyChunk)(nil),                           // 130: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                     // 131: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),           // 132: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),          // 133: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                 // 134: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                // 135: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),              // 136: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),             // 137: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),               // 138: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),              // 139: openshell.v1.RejectDraftChunkResponse
	(*ApproveAllDraftChunksRequest)(nil),          // 140: openshell.v1.ApproveAllDraftChunksRequest
	(*ApproveAllDraftChunksResponse)(nil),         // 141: openshell.v1.ApproveAllDraftChunksResponse
	(*EditDraftChunkRequest)(nil),                 // 142: openshell.v1.EditDraftChunkRequest
	(*EditDraftChunkResponse)(nil),                // 143: openshell.v1.EditDraftChunkResponse
	(*UndoDraftChunkRequest)(nil),                 // 144: openshell.v1.UndoDraftChunkRequest
	(*UndoDraftChunkResponse)(nil),                // 145: openshell.v1.UndoDraftChunkResponse
	(*ClearDraftChunksRequest)(nil),               // 146: openshell.v1.ClearDraftChunksRequest
	(*ClearDraftChunksResponse)(nil),              // 147: openshell.v1.ClearDraftChunksResponse
	(*GetDraftHistoryRequest)(nil),                // 148: openshell.v1.GetDraftHistoryRequest
	(*DraftHistoryEntry)(nil),                     // 149: openshell.v1.DraftHistoryEntry
	(*GetDraftHistoryResponse)(nil),               // 150: openshell.v1.GetDraftHistoryResponse
	(*PolicyRevisionPayload)(nil),                 // 151: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                     // 152: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                  // 153: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                      // 154: openshell.v1.StoredDraftChunk
	nil,                                           // 155: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                           // 156: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                           // 157: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                           // 158: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                           // 159: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                           // 160: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                           // 161: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                           // 162: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                           // 163: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                           // 164: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                           // 165: openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	nil,                                           // 166: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	nil,                                           // 167: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	(*v1.ObjectMeta)(nil),                         // 168: openshell.datamodel.v1.ObjectMeta
	(*v11.SandboxPolicy)(nil),                     // 169: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                       // 170: google.protobuf.Struct
	(*v1.Provider)(nil),                           // 171: openshell.datamodel.v1.Provider
	(*v11.NetworkEndpoint)(nil),                   // 172: openshell.sandbox.v1.NetworkEndpoint
	(*v11.NetworkBinary)(nil),                     // 173: openshell.sandbox.v1.NetworkBinary
	(*v11.SettingValue)(nil),                      // 174: openshell.sandbox.v1.SettingValue
	(*v11.NetworkPolicyRule)(nil),                 // 175: openshell.sandbox.v1.NetworkPolicyRule
	(*v11.L7DenyRule)(nil),                        // 176: openshell.sandbox.v1.L7DenyRule
	(*v11.L7Rule)(nil),                            // 177: openshell.sandbox.v1.L7Rule
	(*v11.GetSandboxConfigRequest)(nil),           // 178: openshell.sandbox.v1.GetSandboxConfigRequest
	(*v11.GetGatewayConfigRequest)(nil),           // 179: openshell.sandbox.v1.GetGatewayConfigRequest
	(*v11.GetSandboxConfigResponse)(nil),          // 180: openshell.sandbox.v1.GetSandboxConfigResponse
	(*v11.GetGatewayConfigResponse)(nil),          // 181: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	4,   // 0: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	168, // 1: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	12,  // 2: openshell.v1.Sandbox.spec:type_name -> openshell.v1.SandboxSpec
	14,  // 3: openshell.v1.Sandbox.status:type_name -> openshell.v1.SandboxStatus
	0,   // 4: openshell.v1.Sandbox.phase:type_name -> openshell.v1.SandboxPhase
	155, // 5: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	13,  // 6: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	169, // 7: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	156, // 8: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	157, // 9: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	158, // 10: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	170, // 11: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	170, // 12: openshell.v1.SandboxTemplate.volume_claim_templates:type_name -> google.protobuf.Struct
	15,  // 13: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	159, // 14: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	12,  // 15: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	160, // 16: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	11,  // 17: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	11,  // 18: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	171, // 19: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	11,  // 20: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	11,  // 21: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	39,  // 22: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	168, // 23: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	38,  // 24: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	161, // 25: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	43,  // 26: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	44,  // 27: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	45,  // 28: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	122, // 29: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	123, // 30: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	47,  // 31: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	42,  // 32: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	50,  // 33: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	168, // 34: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	11,  // 35: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	54,  // 36: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	16,  // 37: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	55,  // 38: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	131, // 39: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	162, // 40: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	171, // 41: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	171, // 42: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	163, // 43: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	171, // 44: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	171, // 45: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	81,  // 46: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	69,  // 47: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	1,   // 48: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	68,  // 49: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	1,   // 50: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	168, // 51: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	1,   // 52: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	164, // 53: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	70,  // 54: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	1,   // 55: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	165, // 56: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	70,  // 57: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	70,  // 58: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 59: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	67,  // 60: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	172, // 61: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	173, // 62: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	71,  // 63: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	168, // 64: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	81,  // 65: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	81,  // 66: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	81,  // 67: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	65,  // 68: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	66,  // 69: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	81,  // 70: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	65,  // 71: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	66,  // 72: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	166, // 73: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	167, // 74: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	169, // 75: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	174, // 76: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	95,  // 77: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	96,  // 78: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	97,  // 79: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	98,  // 80: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	99,  // 81: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	100, // 82: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	101, // 83: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	175, // 84: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	176, // 85: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	177, // 86: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	109, // 87: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	109, // 88: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	3,   // 89: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	3,   // 90: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	169, // 91: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	54,  // 92: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	54,  // 93: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	116, // 94: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	119, // 95: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	126, // 96: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	127, // 97: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	117, // 98: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	118, // 99: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	120, // 100: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	121, // 101: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	127, // 102: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	122, // 103: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	123, // 104: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	124, // 105: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	128, // 106: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	175, // 107: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	129, // 108: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	130, // 109: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	130, // 110: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	175, // 111: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	149, // 112: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	169, // 113: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	175, // 114: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	9,   // 115: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	17,  // 116: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	18,  // 117: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	19,  // 118: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	20,  // 119: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	21,  // 120: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	22,  // 121: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	23,  // 122: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	30,  // 123: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	32,  // 124: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	33,  // 125: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	34,  // 126: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	36,  // 127: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	40,  // 128: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	42,  // 129: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	48,  // 130: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	49,  // 131: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	56,  // 132: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	57,  // 133: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	58,  // 134: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	63,  // 135: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	64,  // 136: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	85,  // 137: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	87,  // 138: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	59,  // 139: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	73,  // 140: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	75,  // 141: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	77,  // 142: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	79,  // 143: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	60,  // 144: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	90,  // 145: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	178, // 146: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	179, // 147: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	94,  // 148: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	103, // 149: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	105, // 150: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	107, // 151: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	92,  // 152: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	110, // 153: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	111, // 154: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	114, // 155: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	125, // 156: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	52,  // 157: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	132, // 158: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	134, // 159: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	136, // 160: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	138, // 161: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	140, // 162: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	142, // 163: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	144, // 164: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	146, // 165: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	148, // 166: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	5,   // 167: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	7,   // 168: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	10,  // 169: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	24,  // 170: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	24,  // 171: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	25,  // 172: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	26,  // 173: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	27,  // 174: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	28,  // 175: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	29,  // 176: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	31,  // 177: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	39,  // 178: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	39,  // 179: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	35,  // 180: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	37,  // 181: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	41,  // 182: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	46,  // 183: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	48,  // 184: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	46,  // 185: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	61,  // 186: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	61,  // 187: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	62,  // 188: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	84,  // 189: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	83,  // 190: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	86,  // 191: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	88,  // 192: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	61,  // 193: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	74,  // 194: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	76,  // 195: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	78,  // 196: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	80,  // 197: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	89,  // 198: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	91,  // 199: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	180, // 200: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	181, // 201: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	102, // 202: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	104, // 203: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	106, // 204: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	108, // 205: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	93,  // 206: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	113, // 207: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	112, // 208: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	115, // 209: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	125, // 210: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	53,  // 211: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	133, // 212: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	135, // 213: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	137, // 214: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	139, // 215: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	141, // 216: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	143, // 217: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	145, // 218: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	147, // 219: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	150, // 220: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	6,   // 221: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	8,   // 222: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	169, // [169:223] is the sub-list for method output_type
	115, // [115:169] is the sub-list for method input_type
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[8].OneofWrappers = []any{}
	file_openshell_proto_msgTypes[41].OneofWrappers = []any{
		(*ExecSandboxEvent_Stdout)(nil),
		(*ExecSandboxEvent_Stderr)(nil),
		(*ExecSandboxEvent_Exit)(nil),
	}
	file_openshell_proto_msgTypes[42].OneofWrappers = []any{
